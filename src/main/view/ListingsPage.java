        ...
        e -> {
          ...
          save.addActionListener(
            p -> {
              ...
              listingtype.setText(type.getText());
              listingBedrooms.setText(String.valueOf(bedrooms.getValue()));
              listingBathrooms.setText(String.valueOf(bathrooms.getValue()));
              listingQuadrant.setText(quadrant.getSelectedItem().toString());
              listingFurnished.setText(
                String.valueOf(furnished.getSelectedItem())
              );
