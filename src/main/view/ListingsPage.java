...
public class ListingsPage extends Page {
    ...
    public void draw() {
        ...
        JLabel listingtype = new JLabel(controller.getCurrentProperty().getSpecifications().getHousingType());
        JLabel listingBedrooms = new JLabel(
                String.valueOf(controller.getCurrentProperty().getSpecifications().getNumOfBedrooms()));
        JLabel listingBathrooms = new JLabel(
                String.valueOf(controller.getCurrentProperty().getSpecifications().getNumOfBathrooms()));
        JLabel listingQuadrant = new JLabel(controller.getCurrentProperty().getSpecifications().getCityQuadrant());
        JLabel listingFurnished = new JLabel(
                String.valueOf(controller.getCurrentProperty().getSpecifications().getFurnished()));
        ...
        if (currentUser != null
                && ((currentUser.getUserType() == UserType.LANDLORD
                        && controller.getCurrentProperty().getPostedBy()
            ...
            edit.addActionListener(
                    e -> {
                        ...
                        quadrant.setSelectedItem(controller.getCurrentProperty().getSpecifications().getCityQuadrant());
                        ...
                        furnished.setSelectedItem(controller.getCurrentProperty().getSpecifications().getFurnished());
                        ...
                        save.addActionListener(
                                p -> {
                                    ...
                                    controller.getPostingController().changeListingQuadrant(id, quadrant.getSelectedItem().toString());

                                    controller.getCurrentProperty().getSpecifications()
                                            .setNumOfBathrooms(Integer.valueOf(bathrooms.getValue()));
                                    controller.getPostingController().changeListingBathrooms(id, Integer.valueOf(bathrooms.getValue()));

                                    controller.getCurrentProperty().getSpecifications()
                                            .setNumOfBedrooms(Integer.valueOf(bedrooms.getValue()));
                                    controller.getPostingController().changeListingBedrooms(id, Integer.valueOf(bedrooms.getValue()));

                                    controller.getCurrentProperty().getSpecifications().setHousingType(type.getText());
                                    controller.getPostingController().changeListingType(id, type.getText());

                                    controller.getCurrentProperty().getSpecifications()
                                            .setFurnished((boolean) furnished.getSelectedItem());
                                    controller.getPostingController().changeListingFurnishing(id, (boolean) furnished.getSelectedItem());
                                    
                                    listingtype.setText(
                                            controller.getCurrentProperty().getSpecifications().getHousingType());
                                    listingBedrooms.setText(
                                            String.valueOf(controller.getCurrentProperty().getSpecifications()
                                                    .getNumOfBedrooms()));
        ...
        filters.addActionListener(
                e -> {
                    ...
                    save.addActionListener(
                            p -> {
                                ListingState new_state = ListingState
                                        .valueOf(changeListingState.getSelectedItem().toString());
                                controller.getPostingController().changeListingState(id, new_state.ordinal());
                                state.setText(controller.getPostingController().getListingState(id).toString()); // change
                                                                                                                 // //
                                                                                                                 // listing
                                pop.setVisible(false);
                            });
        ...
        if (currentUser != null) {
            ...
            if ((currentUser.getUserType() == UserType.LANDLORD
                    && controller.getCurrentProperty().getPostedBy().equals(currentUser.getEmail())) // landlord only
                                                                                                     // views their own
                                                                                                     // postings
                    || currentUser.getUserType() == UserType.MANAGER) {
                f.add(filters);
